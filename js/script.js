...
var countDownDateFirst = new Date("Jan 15, 2023 15:37:25").getTime();
...
var x = setInterval(function () {
  ...
  // Second Timer
  var countDownDateSecond = new Date("Jan 25, 2023 15:00:25").getTime();

  // Find the distance between now and the count down date
  distance = countDownDateSecond - now;
